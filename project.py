...
api_key = sys.argv[1] #!!ОБЯЗАТЕЛЬНО ЗАМЕНИТЬ, ПЕРЕД ИСПОЛЬЗОВАНИЕМ!!
...
class MainWindow(QMainWindow):#Дальше живут драконы
    ...
    def click(self):
         ...
         table(parser(filename),filename[:-5]+'_результаты.xlsx') #использование функций для чтения файла, рассчётов и записи в файл с названием в формате оригинальное название + _результаты
